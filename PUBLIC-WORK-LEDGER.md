...
| Construct | Roman is asked to conduct a follow-on review because of his deep understanding of the code | Construct contributor | [Open request](https://github.com/construct-worlds/construct/pull/1199#issuecomment-5174411416) |
| Construct | Roman's counter-evidence is acknowledged as the useful correction | Construct contributor | [Open acknowledgement](https://github.com/construct-worlds/construct/pull/1199#issuecomment-5179524206) |
| NVIDIA Guardrails | Roman's framing is described as the relevant distinction for a decision record bound to the exact invocation | Independent participant in an NVIDIA-owned repository | [Open response](https://github.com/NVIDIA-NeMo/Guardrails/issues/2001#issuecomment-4638577332) |
| MCP Security Dojo | The project owner preserves Roman's authority-before-side-effect and exact-argument-binding invariant | Project owner | [Open owner acknowledgement](https://github.com/dgenio/mcp-agent-security-dojo/issues/43#issuecomment-5251916448) |
| Vercel AI | Roman's policy, binding, and evidence separation is mapped to a concrete receipt primitive | Independent participant in a Vercel-owned repository | [Open response](https://github.com/vercel/ai/issues/13215#issuecomment-4781451751) |
...
| CrewAI | A contributor follows Roman's narrow runnable-fixture option | Independent contributor | [Open implementation response](https://github.com/crewAIInc/crewAI/pull/6030#issuecomment-4889389386) |
| Vercel AI | An implementation data point preserves Roman's signing-versus-anchoring separation | Independent participant in a Vercel-owned repository | [Open implementation data point](https://github.com/vercel/ai/issues/13215#issuecomment-4912787884) |
| Microsoft AutoGen | Roman's revised-argument edge case is used to explain why rewritten calls require a new decision | Independent contributor in a Microsoft-owned repository | [Open peer recognition](https://github.com/microsoft/autogen/issues/7405#issuecomment-5226759945) |
| OpenAI Codex | Roman's approval-state framing and his observation-authority-action separation are each directly discussed | Independent participants in an OpenAI-owned repository | [Open approval-state response](https://github.com/openai/codex/issues/29627#issuecomment-4803049595) · [Open separation response](https://github.com/openai/codex/issues/21753#issuecomment-4793411247) |
...
| Stripe AI | Consequential payment-authority gap | [Open issue](https://github.com/stripe/ai/issues/402) |
